                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="admin_shop.php" class="nav-item nav-link">Shop</a>
...
?>
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <h2>Mr/Mrs: <?=$nomclient; ?></h2>
                    <p>Email: <?=$emailclient; ?></p>
                    <p>Téléphone: <?=$phoneclient; ?></p>
                    <p>Produit: <?=$produit; ?></p>
                    <p>Quantitée(s): <?=$quantite; ?></p>
                    <p>Adresse de livraison: <?=$adresseclient; ?></p>
                    <p>Date de livraison: <?=$datelivraison; ?></p>
                    <p>Une message: <?=$messageclient; ?></p>
                    <div class="d-flex align-items-center mb-1">
                        <input type="submit" class="btn btn-danger btn-sm" value="Livré" name="livre">
                    </div>
                </div>
            </div>

...
include("../Utils/db.php");
  if(isset($_POST['annule'])){
    ...
    $query = "DELETE INTO panier (produit,quantité,nomclient,emailclient,phoneclient,adresseclient,datelivraison,messageclient) WHERE produit= '$produit'";
...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="commande.php" class="btn px-0 ml-3">
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Commande</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <!-- Commande Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Commande</span></h2>
        <div class="row px-xl-5">
<?php  		     
...
?>
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    <p>Date de livraison: <?=$datelivraison; ?></p>
                    <p>Votre contact: <?=$phoneclient; ?></p>
                    <div class="d-flex align-items-center mb-1">
                        <input type="submit" class="btn btn-danger btn-sm" value="Annulé" name="annule">
                    </div>
                </div>
            </div>

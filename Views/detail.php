            ...
            <div class="col-lg-5 mb-30">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="img-fluid w-100" src= "<?= "admin/images/".$image?>" alt="<?= $nom ?>">
                        </div>
                    </div>
            </div>
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1"><?=$quantite; ?> environ</small>
                    </div>
                    <h3 class="font-weight-semi-bold mb-4"><?=$nom; ?> Ar</h3>
                    <p class="mb-4"><?=$detail; ?></p>
                    <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">Tailles:</strong>
                        <form>
                    ...
                    <div class="d-flex mb-4">
                        <strong class="text-dark mr-3">Couleur:</strong>
                        <form>
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a href="panier.php?panier=<?php echo $id ?>"><button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i>Ajouté sur le panier</button></a>
                    </div>
                    <div class="d-flex pt-2">
                        <strong class="text-dark mr-2">Partager:</strong>
                        <div class="d-inline-flex">
                            ...
                            <a class="text-dark px-2" href="https://fr.linkedin.com/">

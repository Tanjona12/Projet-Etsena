...
<head>
    <meta charset="utf-8">
    <title>Profil sur E-tsena</title>
...
<body>
    ...
    <!-- Contact Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Profil</span></h2>
        <div class="row px-xl-5">
                ...
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        <?php
                            ...
                            $req = mysqli_query($con , "SELECT * FROM user WHERE email = '$mail' ");
                            $row = mysqli_fetch_assoc($req);}
                        ?>
                        <div class="control-group">
                            <h3><i class="fa-regular fa-hashtag"></i> N o m : <?php echo $nom ?> </h3><br>
                        </div>
                        <div class="control-group">
                            <h3><i class="fa-sharp fa-solid fa-envelope"></i>  E m a i l : <?php echo $mail ?> </h3><br>
                        </div>
                        <div class="control-group">
                            <h3><i class="fa-sharp fa-solid fa-phone"></i>  P h o n e : <?php echo $telephone ?> </h3><br>
                        </div>
                        <div>
                            <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton"><a href="../Utils/deconnexion.php">Déconnexion</a></button>
                        </div>
                    </form>
                </div>
            </div>

...
?>
                    ...
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="panier.php?panier=<?php echo $id ?>"><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href="detail.php?detail=<?php echo $id ?>"><i class="fa-solid fa-circle-info"></i></a>
                        </div>
                    </div>
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href=""><?=$nom; ?></a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?=$prix; ?>Ar</h5>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <a href="panier.php?panier=<?php echo $id ?>" class="btn btn-primary">Shop Now</a>
                        </div>
                    </div>
